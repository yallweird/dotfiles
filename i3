...
bindsym Print exec scrot ~/Pictures/screens/%Y-%m-%d-%T-screenshot.png && notify-send "Screenshot saved to ~/Pictures/screens/$(date +"%Y-%m-%d-%T")-screenshot.png"
...
# zsh auto & syntax
exec --no-startup-id source /usr/share/zsh/plugins/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
exec --no-startup-id source /usr/share/zsh/plugins/zsh-autosuggestions/zsh-autosuggestions.zsh 
...
exec --no-startup-id sleep 1 && feh --bg-fill ~/Pictures/walls/waves.png
